...
export type ReviewItem={id:string;area:ReviewArea;title:string;detail:string;source:string;recordId:string;useTargets?:ReviewUseTarget[];assy?:string;part?:string;itemNumber?:string;itemName?:string;bom?:BomFact};
