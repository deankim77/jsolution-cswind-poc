...
test('production workspace and editor hooks remain unconditional across tab renders',()=>{
 for(const path of ['app/v2/production-workspace.tsx','app/v2/customer-data-workspace.tsx','app/v2/customer-analysis-results.tsx','app/v2/trr-review-details.tsx','app/v2/trr-workspace.tsx','app/v2/production-bulk-dialog.tsx','app/production-editor/page.tsx']){
