...
const workspaceLabels:Record<WorkspaceView,string>={portfolio:"글로벌 대시보드",projects:"프로젝트 목록",dashboard:"프로젝트 대시보드","edit-project":"프로젝트 정보 수정","create-project":"새 프로젝트",templates:"프로젝트 템플릿","template-editor":"템플릿 편집","workflow-templates":"워크플로우 템플릿",wbs:"PROJECT HUB",documents:"문서 · 산출물","product-data":"PART · BOM","bom-compare":"BOM 비교",cost:"원가 관리",workflows:"워크플로우","create-workflow":"새 워크플로우",ecr:"설계변경","create-ecr":"새 설계변경",quality:"품질관리","create-quality":"새 품질문제",issues:"이슈 · 리스크",reports:"보고 · 회의","my-work":"MY WORK","my-ai":"MY AI HOME",settings:"시스템 설정","artifact-preview":"AI 결과 미리보기"};
