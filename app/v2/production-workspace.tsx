...
export const productionTabs=[['customer','고객 Data'],['review','AI Data Review'],['pbom','PBOM'],['extract','AI 추출사항'],['ttr','TRR']] as const;
