...
- BOM 편집기의 REUSE/CURRENT/REFERENCE 제목은 영문 라벨·제목의 같은 높이 2줄로 맞춘다. 중복 편집 안내는 제거하고 타인 잠금 정보는 상단에서 제공한다. 편집 도구는 글자 14px·아이콘 18px·버튼 34px 공통 토큰을 사용하며 3개 영역의 도구 행 높이도 통일한다.
